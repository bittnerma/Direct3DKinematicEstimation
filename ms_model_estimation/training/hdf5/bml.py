...
from ms_model_estimation.training.camera.cameralib import *
from tqdm import trange
from ms_model_estimation.training.utils.OSUtils import LeafJoints, PredictedBones, PredictedCoordinates, \
    PredictedOSJoints
...
def search_bml_data_list(hdf5Folder, opensimGTFolder, fullBodyPath, postfix="_MoSh", duration=1):
    ...
    pyBaseModel = OpenSimDataReader.read_opensim_model(fullBodyPath)
