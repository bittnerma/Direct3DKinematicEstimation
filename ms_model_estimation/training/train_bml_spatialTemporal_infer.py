...
from ms_model_estimation.training.config.config_bml_spatialtemporal_time import get_cfg_defaults
...
class Training(TorchTrainingProgram):
    ...
    def __init__(self, args, cfg):
        ...
        '''
        pyOpensimModel = OpenSimDataReader.read_opensim_model(self.cfg.OPENSIM.MODELPATH)
