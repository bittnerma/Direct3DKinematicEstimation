...
script url: https://github.com/facebookresearch/VideoPose3D/blob/master/common/model.py
...
class TemporalModelBase(nn.Module):
    ...
    def forward(self, x):
        ...
        x = x.permute(0, 2, 1)
        x = x.view(batchSize, -1, self.out_features)
...
class TemporalModel(TemporalModelBase):
    ...
    def __init__(self, in_features, out_features,
                 filter_widths, causal=True, dropout=0.25, channels=1024, dense=False):
        """
        ...
        """
        super().__init__(in_features, out_features, filter_widths, causal, dropout, channels)

        print(f'Casual : {causal}')
...
class TemporalModelOptimized1f(TemporalModelBase):
    ...
    def __init__(self, in_features, out_features,
        ...
        self.expand_conv = nn.Conv1d(in_features, channels, filter_widths[0], stride=filter_widths[0],
                                     bias=False)
