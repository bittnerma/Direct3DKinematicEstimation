from ms_model_estimation.training.config.config_bml import get_cfg_defaults as get_img_defaults
from ms_model_estimation.training.utils.OSUtils import PredictedBones, PredictedOSJoints, PredictedCoordinates, LeafJoints, \
